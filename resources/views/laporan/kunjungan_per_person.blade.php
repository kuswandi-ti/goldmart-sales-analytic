...
@section('page_title')
    {{ __('Laporan Kunjungan per Person') }}
@endsection
...
@section('section_header_breadcrumb')
    @parent
    <x-breadcrumb-active title="{{ __('Daftar Data Laporan Kunjungan per Person') }}" />
@endsection
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            {{ __('Daftar Data Laporan Kunjungan per Person') }}
                            <p class="subtitle text-muted fs-12 fw-normal">
                                {{ __('Menampilkan semua data kunjungan per person') }}
                            </p>
                        </div>
                        <form action="{{ route('laporan.kunjunganperperson') }}" method="GET" id="form-search">
                            @csrf
...
@push('scripts')
    <script>
        ...
        Highcharts.chart('kunjunganstatistic1', {
            ...
            title: {
                text: 'Grafik Kunjungan per Person'
            },
            subtitle: {
                text: e
            },
