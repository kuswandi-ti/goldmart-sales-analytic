...
@section('section_header_breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ __('Memperbarui Data Customer Visit (Mencoba)') }}</li>
@endsection
                ...
                <div class="flex-wrap card-header d-flex align-items-center flex-xxl-nowrap">
                    <div class="flex-fill">
                        <div class="card-title">
                            {{ __('Memperbarui Data Customer Visit (Mencoba)') }}
                            <p class="subtitle text-muted fs-12 fw-normal">
                                {{ __('Silahkan input data untuk proses memperbarui data customer visit (mencoba)') }}
                            </p>
                        </div>
                    </div>
                    <div class="d-flex">
                                                ...
                                                <tr>
                                                    <td width="50%">
                                                        <select
                                                            ...
                                                            name="goldmart[]" multiple="multiple" disabled>
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-3 form-check-lg form-switch">
                                        <input class="form-check-input form-checked-danger" value="Goldmaster"
                                            ...
                                            disabled>
                                        <label class="form-check-label" for="chk-goldmaster">{{ __('Goldmaster') }}</label>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td width="50%">
                                                        <select
                                                            class="js-example-placeholder-single js-states form-control select2"
                                                            name="goldmaster[]" multiple="multiple" disabled>
